...
public class Critter extends Actor
{
    ...
    public void processActors(ArrayList<Actor> actors)
    {
        ...
        }//if there isn't a rock or critter nearby, the actors will delete themselves. so if adjacent squares are empty, nothing happens. if a bug is there it goes away.
    }
